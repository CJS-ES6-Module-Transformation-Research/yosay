...
console.log(yosay('That\u2019s it. Feel free to fire up the server with ' + chalk.green('`npm run start:dev`') + 'or use our subgenerator to create endpoints.'));
...
console.log(yosay('That\u2019s it. Feel free to fire up the server with ' + chalk.green('`npm run start:dev`') + '.'));
console.log(yosay('That\u2019s it. Feel free to fire up the server with ' + '`npm run start:dev`.'));
console.log(yosay(`Welcome to the polished ${ chalk.red('something iloveunicornsiloveunicornsiloveunicornsiloveunicornsiloveunicornsiloveunicorns') } generator!`));
console.log(yosay(`Welcome to the polished ${ chalk.red('something iloveunicornsiloveunicornsiloveunicornsiloveunicornsiloveunicornsiloveunicorns') } generator! Another long sentence ${ chalk.yellow('something iloveunicornsiloveunicornsiloveunicornsiloveunicornsiloveunicornsiloveunicorns') }normal text`));